...
for epoch_index in range(num_epochs):
    ...
    model.fit_generator(datagen, samples_per_epoch=samples_per_epoch, nb_epoch=1, verbose=1, validation_data=validation_datagen, nb_val_samples=nb_val_samples, callbacks=cbks)
